...
public class BloomNativeImageCropView extends AppCompatImageView {
    ...
    private BloomNativeImageCropView.OnImageViewTouchDoubleTapListener mDoubleTapListener;
    private BloomNativeImageCropView.OnImageViewTouchSingleTapListener mSingleTapListener;

    private boolean isChangingScale = false;

    private float[] suppMatrixValues = new float[9];

    public BloomNativeImageCropView(Context context) {
        this(context, null);
    }

    public BloomNativeImageCropView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BloomNativeImageCropView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BloomNativeImageCropView);

        mOutsideLayerPaint = new Paint();
        int outsideLayerColor = a.getColor(R.styleable.BloomNativeImageCropView_bloom_native_outsideLayerColor, Color.parseColor(DEFAULT_OUTSIDE_LAYER_COLOR_ID));
        mOutsideLayerPaint.setColor(outsideLayerColor);

        setScaleType(ScaleType.MATRIX);

        mGridInnerLinePaint = new Paint();
        float gridInnerStrokeWidth = a.getDimension(R.styleable.BloomNativeImageCropView_bloom_native_gridInnerStroke, 1);
        mGridInnerLinePaint.setStrokeWidth(gridInnerStrokeWidth);
        int gridInnerColor = a.getColor(R.styleable.BloomNativeImageCropView_bloom_native_gridInnerColor, Color.WHITE);
        mGridInnerLinePaint.setColor(gridInnerColor);

        mGridOuterLinePaint = new Paint();
        float gridOuterStrokeWidth = a.getDimension(R.styleable.BloomNativeImageCropView_bloom_native_gridOuterStroke, 1);
        mGridOuterLinePaint.setStrokeWidth(gridOuterStrokeWidth);
        int gridOuterColor = a.getColor(R.styleable.BloomNativeImageCropView_bloom_native_gridOuterColor, Color.WHITE);
        mGridOuterLinePaint.setColor(gridOuterColor);
        mGridOuterLinePaint.setStyle(Paint.Style.STROKE);

        gridInnerMode = a.getInt(R.styleable.BloomNativeImageCropView_bloom_native_setInnerGridMode, GRID_OFF);
        gridOuterMode = a.getInt(R.styleable.BloomNativeImageCropView_bloom_native_setOuterGridMode, GRID_OFF);

        gridLeftRightMargin = a.getDimension(R.styleable.BloomNativeImageCropView_bloom_native_gridLeftRightMargin, 0);
        gridTopBottomMargin = a.getDimension(R.styleable.BloomNativeImageCropView_bloom_native_gridTopBottomMargin, 0);
    ...
    public class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            return BloomNativeImageCropView.this.onSingleTapConfirmed(e);
        }
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            return BloomNativeImageCropView.this.onScroll(e1, e2, distanceX, distanceY);
        }
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            return BloomNativeImageCropView.this.onFling(e1, e2, velocityX, velocityY);
        }

        @Override
        public boolean onSingleTapUp(MotionEvent e) {
            return BloomNativeImageCropView.this.onSingleTapUp(e);
        }

        @Override
        public boolean onDown(MotionEvent e) {
            return BloomNativeImageCropView.this.onDown(e);
        }
    }
