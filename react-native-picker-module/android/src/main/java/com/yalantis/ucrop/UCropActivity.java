...
public class UCropActivity extends AppCompatActivity {
    ...
    public static final int DEFAULT_COMPRESS_MAX_SIZE_BYTES = 0;
    ...
    private int mCompressionMaxSizeBytes = DEFAULT_COMPRESS_MAX_SIZE_BYTES;
...
//        }
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mCompressionMaxSizeBytes = intent.getIntExtra(UCrop.Options.EXTRA_COMPRESSION_MAX_SIZE_BYTES, UCropActivity.DEFAULT_COMPRESS_MAX_SIZE_BYTES);
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mNextButtonText = intent.getStringExtra(UCrop.Options.EXTRA_UCROP_NEXT_BUTTON_TEXT);
    ...
    private void setupAppBar() {
        ...
        btnSave.setText(mNextButtonText);
