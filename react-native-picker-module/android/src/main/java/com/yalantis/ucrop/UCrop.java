...
import tgio.github.com.mediapickerlib.BuildConfig;
...
public class UCrop {
    ...
    public static class Options {
        ...
        public static final String EXTRA_COMPRESSION_MAX_SIZE_BYTES = EXTRA_PREFIX + ".CompressionMaxSizeBytes";
        ...
        public static final String EXTRA_UCROP_NEXT_BUTTON_TEXT = EXTRA_PREFIX + ".UcropNextButtonText";
        ...
        public void setMaxSizeBytes(int maxSizeBytes) {
            mOptionBundle.putInt(EXTRA_COMPRESSION_MAX_SIZE_BYTES, maxSizeBytes);
        }
        ...
        public void setNextButtonText(@Nullable String text) {
            mOptionBundle.putString(EXTRA_UCROP_NEXT_BUTTON_TEXT, text);
        }
