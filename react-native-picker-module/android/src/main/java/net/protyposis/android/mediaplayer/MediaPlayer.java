...
public class MediaPlayer {
    ...
    public int getVideoWidth() {
        ...
        if(rotation == 90 || rotation == 270) {
            width = mVideoFormat.getInteger(MediaFormat.KEY_HEIGHT);
        } else {
            width = mVideoFormat.getInteger(MediaFormat.KEY_WIDTH);
        }
        return mVideoFormat != null ? width : 0;
    }
    ...
    public int getVideoHeight() {
        ...
        int height = 0;
        if(rotation == 90 || rotation == 270) {
            height = mVideoFormat.getInteger(MediaFormat.KEY_WIDTH);
        } else {
            height = mVideoFormat.getInteger(MediaFormat.KEY_HEIGHT);
        }
        return mVideoFormat != null ? height : 0;
    }
